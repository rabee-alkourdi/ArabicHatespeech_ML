...
# embedding_matrix = create_embedding_matrix('initial datasets/cc.ar.300.vec',
...
model.add(layers.Conv1D(200, 2, activation='relu'))
...
confusion_lr = confusion_matrix(y_test, y_pred_bool)